...
SYNONYMS = [ ("220 Fladbury, Jubilee Bridge", "fladbury, Jubilee Bridge", "Jubilee Bridge Fladbury", "Jubilee Bridge", "Jubilee"),
             ...
             ("Alveston Swiffen Bank", "Alveston Swiffen Bank","Swiffen Bank","Alveston - Swiffen Bank"),
             ...
             ("Bredon - Bredon Marina","Bredon Marina","Bredon Marina","Dock Lane Bredon","Dock Lane.Bredon", "Dock lane. Bredon", "Bredon docklane"),
             ...
             ("Peopleton - Mill Bridge","Mill Bridge, Peopleton", "Mill  Bridge, Peopleton", "Mill Bridge Peopleton", "Mill Bridge, Peopleton", "Mill Bridge,Peopleton", "Mill Bridge  Peopleton"),
             ...
             ("Stowe, New Zealand Spinney", "R. Stowe,New Zealand Spinney","R.Stowe, New Zealand Spinney, Stockton","R.Stowe, New Zealand Spinney","New Zealand Spinney"),
             ...
             ("Welford-on-Avon - Boat Station", "Welford Boat Station"),
             ("Welford on Avon above weir","Welford angling"),
             ("Weston-on-Avon - Duck Ln", "Weston on Avon", "Weston on Avon"),
             ...
             ("Barford - Hampton Wood","Hampton Wood"),
...
SAMPLING_LOCATIONS = [
    ...
    ("Warwickshire Avon",0,"Bredon`s Norton - Severn Sailing Club",52.05072,-2.11747),
    ...
    ("Stratford-upon-Avon Canal - Preston Bagot - Canal",52.28699,-1.74503),
    ...
    ("Whitsun Brook",0,"Church Lench - Low Rd",52.16841,-1.96037),
    ("Whitsun Brook",0,"Rous Lench - Rd to Bishampton",52.16985,-1.99032)
]
